...
#define DFL_CA_PATH             "/home/sgx/certificate"
#define DFL_CRT_FILE            "server.crt"
#define DFL_KEY_FILE            "server.key"
...
//#endif
    ...
    mbedtls_printf("in M_BEDTLS_RSA\n");
#endif
#if defined(MBEDTLS_ECDSA_C)
#undef MBEDTLS_ECDSA_C
    mbedtls_printf("mbedtls_test_ca_crt_ec\n");
#endif
        ...
        strcmp( opt.key_file2, "none" ) != 0 )
    {
      ...
      if( ( ret = mbedtls_x509_crt_parse( &srvcert,
        ...
        if( ( ret = mbedtls_pk_parse_key( &pkey,
                                  ...
                                  mbedtls_test_srv_key_rsa_len, "xiaolong", 8 ) ) != 0 )
        {
